                ...
                <div className={`${styles.container} container`}>
                    <div>
                        <div className={styles.mainTitle}>
                            <span className={styles.text}>ABBSNET</span>
                        </div>
                        <div className={styles.subTitle}>
                            Лучший поставщик доступов в СНГ
                        </div>
                        <a href="https://t.me/+za3WIpVmr2tkNjcy" target='_blank'><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        ...
                        <ul>
                            <li><a href="https://abbsnet.com/download">Windows</a></li>
                            <li><a href="https://abbsnet.com/download">MacOS (Intel)</a></li>
                            <li><a href="https://abbsnet.com/download">MacOS (M-processor)</a></li>
                        </ul>
                    </div>
                </div>
            </section>
